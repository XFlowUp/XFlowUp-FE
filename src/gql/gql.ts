...
const documents: Documents = {
  ...
  '\n  mutation UpdateServicePrompt($serviceId: Float!, $prompt: String!) {\n    updateServicePrompt(service_id: $serviceId, prompt: $prompt) {\n        ... on UpdateServiceSettingsSuccessResult {\n        status\n        }\n        ... on UpdateServiceSettingsErrorResult {\n        status\n        message\n        }\n    }\n}\n':
    types.UpdateServicePromptDocument,
  '\n  query GetAllServices($projectSlug: String!) {\n    get_all_services(project_slug: $projectSlug) {\n      ... on GetAllServicesSuccessResult {\n        status\n        services {\n          id\n          type\n          name\n          lastDeploymentDate\n        }\n      }\n      ... on GetAllServicesFailedResult {\n        status\n        message\n      }\n    }\n  }\n':
  ...
  '\n  query GetBuildLogStream($buildLogId: String!) {\n    getBuildLogStream(buildLogId: $buildLogId)\n}\n':
    types.GetBuildLogStreamDocument,
  '\n  query GetDeployLogStream($deploymentId: String!) {\n    getDeployLogStream(deploymentId: $deploymentId)\n  }\n':
    types.GetDeployLogStreamDocument,
  '\n    query ProjectsQuery {\n    all_projects {\n      ... on ProjectSuccess {\n        result\n        data {\n            id\n            name\n            description\n            slug\n            url\n            created_at\n            updated_at\n        }\n      }\n      ... on ProjectError {\n        result\n        message\n      }\n    }\n}\n':
