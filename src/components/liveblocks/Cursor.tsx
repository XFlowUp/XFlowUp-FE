...
import { getContrastingColor } from '@/shared/utils/getContrastingColor';
import styles from '@/stylesheet/Cursor.module.css';
...
export default function Cursor({
  ...
  return (
    ...
    >
      ...
      {variant === 'avatar' ? <AvatarCursor color={color} avatar={avatar} size={size} /> : null}
    </motion.div>
  );
}
